...
export const metadata: Metadata = {
  ...
  description: 'RFP Quest terms of service. Read our terms and conditions for using the platform.',
};
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8">
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              Welcome to RFP Quest. By accessing or using our platform at rfp.quest, you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not use our service.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
              We may update these Terms from time to time. Continued use of RFP Quest after any changes constitutes acceptance of the new Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              RFP Quest is a tender analysis and bid management platform that helps UK businesses discover and respond to government procurement opportunities. Our services include:
            </p>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              When using RFP Quest, you agree not to:
            </p>
            <ul className="list-disc list-inside text-slate-300 space-y-2 mt-4">
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              RFP Quest aggregates publicly available tender data from UK government sources, including Find a Tender and Contracts Finder. This data is:
            </p>
            <ul className="list-disc list-inside text-slate-300 space-y-2 mt-4">
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              The RFP Quest platform, including its design, features, and content (excluding government tender data), is owned by us and protected by intellectual property laws.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
              You retain ownership of any content you create or upload to RFP Quest, such as company profiles and bid documents. By using our service, you grant us a licence to use this content solely for providing our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              Some features of RFP Quest use artificial intelligence. You acknowledge that:
            </p>
            <ul className="list-disc list-inside text-slate-300 space-y-2 mt-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-2 mt-4">
              <li>RFP Quest is provided &quot;as is&quot; without warranties of any kind</li>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              We may suspend or terminate your access to RFP Quest at any time, with or without cause, including for:
            </p>
            <ul className="list-disc list-inside text-slate-300 space-y-2 mt-4">
