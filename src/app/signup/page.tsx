...
export default function SignupPage() {
  return (
    <>
      {/* Hero Section */}
      <section id="top" className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50/30 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-900/30 dark:bg-blue-950/50 text-blue-300 dark:text-blue-300 rounded-full text-sm font-medium mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-slate-100 dark:text-white leading-[1.1]">
              Get Early Access to
              <span className="block text-blue-400 dark:text-blue-400">rfp.quest</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-300 dark:text-slate-400 max-w-2xl mx-auto mb-12 leading-relaxed">
            ...
            <div className="max-w-md mx-auto">
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-blue-800 hover:bg-blue-800/90 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-600/25 hover:shadow-xl hover:shadow-blue-600/30 hover:-translate-y-0.5 text-lg"
                >
                  Join the Waitlist
                </button>
              </form>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="w-14 h-14 bg-blue-900/30 dark:bg-blue-950/50 rounded-xl flex items-center justify-center mx-auto mb-4">
                <svg className="w-7 h-7 text-blue-400 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 dark:bg-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-slate-100 dark:text-white mb-4">
            Built for UK Procurement
          </h2>
          <p className="text-lg text-slate-300 dark:text-slate-400 text-center max-w-2xl mx-auto mb-12">
      ...
      {/* Final CTA */}
      <section className="py-16 md:py-24 bg-blue-800 dark:bg-blue-800/90">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href="#top"
            className="inline-flex items-center justify-center px-8 py-4 bg-slate-900/60 backdrop-blur-xl border-slate-700/50 text-blue-400 font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-lg"
          >
            Join the Waitlist
