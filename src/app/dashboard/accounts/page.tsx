    ...
    <div className="bg-white rounded-lg border border-gray-200 p-5 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 line-clamp-1">{company.companyName}</h3>
            <p className="text-sm text-gray-500">{company.companyType.toUpperCase()} • Est. {company.dateOfCreation.split('-')[0]}</p>
          </div>
        </div>
        <span className={`px-2 py-1 text-xs font-medium rounded-full ${
          company.signals.overallSentiment === 'positive' ? 'bg-green-50 text-green-700' :
          company.signals.overallSentiment === 'cautious' ? 'bg-amber-50 text-amber-700' :
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        {hasGrowth && (
          <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium bg-teal-50 text-teal-700 rounded-full">
      ...
      {company.sustainability?.secrData && (
        <div className="bg-gray-50 rounded-lg p-3 mb-4">
          <p className="text-xs font-medium text-gray-500 mb-2">Sustainability Data</p>
          <div className="grid grid-cols-3 gap-3 text-sm">
            {company.sustainability.secrData.scope1Tonnes && (
              <div>
                <p className="text-xs text-gray-400">Scope 1</p>
                <p className="font-medium text-gray-800">{company.sustainability.secrData.scope1Tonnes} tCO2e</p>
              </div>
            )}
            {company.sustainability.secrData.scope2Tonnes && (
              <div>
                <p className="text-xs text-gray-400">Scope 2</p>
                <p className="font-medium text-gray-800">{company.sustainability.secrData.scope2Tonnes} tCO2e</p>
              </div>
            )}
            {company.sustainability.secrData.netZeroYear && (
              <div>
                <p className="text-xs text-gray-400">Net Zero</p>
...
export default function AccountsFeedPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Company Accounts Feed</h1>
      ...
      <div className="grid gap-6 md:grid-cols-3 mb-8">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-5 border border-blue-100">
          ...
          <h3 className="font-semibold text-gray-900 mb-1">Company Accounts</h3>
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-5 border border-green-100">
          ...
          <h3 className="font-semibold text-gray-900 mb-1">Sustainability Signals</h3>
          <p className="text-sm text-gray-600">
      ...
      <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mx-auto mb-2 font-bold">1</div>
            <p className="text-sm text-gray-700">Search for any UK company</p>
          </div>
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mx-auto mb-2 font-bold">2</div>
            <p className="text-sm text-gray-700">We fetch their Companies House data</p>
          </div>
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mx-auto mb-2 font-bold">3</div>
            <p className="text-sm text-gray-700">AI extracts SECR from annual accounts</p>
          </div>
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mx-auto mb-2 font-bold">4</div>
            <p className="text-sm text-gray-700">View signals, risks, and bid insights</p>
          </div>
        </div>
      </div>
