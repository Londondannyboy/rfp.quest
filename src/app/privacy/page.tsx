...
export const metadata: Metadata = {
  ...
  description: 'RFP Software Quest privacy policy. Learn how we collect, use, and protect your data.',
};
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8">
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              RFP Software Quest (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform at rfp.quest.
            </p>
            <p className="text-slate-300 leading-relaxed mt-4">
              By using RFP Software Quest, you agree to the collection and use of information in accordance with this policy.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-2 mt-4">
              ...
              <li><strong>Analytics cookies:</strong> Help us understand how you use RFP Software Quest</li>
            </ul>
            <p className="text-slate-300 leading-relaxed mt-4">
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              RFP Software Quest is not intended for users under 18. We do not knowingly collect personal information from children. If you believe we have collected data from a child, please contact us immediately.
            </p>
          </section>
